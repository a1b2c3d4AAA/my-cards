<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="azurePage.aspx.cs" Inherits="WebApplication1.azurePage" %>
    ...
    <tr>
       <td><div class="card"> 
         <div class="card-inner">
            <div class="front front-azure">
               <h1>שאלה</h1> 
           </div>

            <div class="back back-azure">
               <h>שאלההההה?</h> 
           </div>
        </div>
     </div></td>
