    ...
    public partial class mainPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Request.Form["red"] != null)
                {
                    Response.Redirect("redPage.aspx");
                    Response.End();
                }
                if (Request.Form["yellow"] != null)
                {
                    Response.Redirect("yellowPage.aspx");
                    Response.End();
                }
                if (Request.Form["blue"] != null)
                {
                    Response.Redirect("bluePage.aspx");
                    Response.End();
                }
            }
        }
